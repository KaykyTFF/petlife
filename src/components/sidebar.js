 ...
 * Componente Sidebar
 * 
 * Renderiza a barra de navegação lateral (sidebar) da aplicação. 
 * Destaca o item de menu ativo com base no caminho atual da URL.
 *
 * @returns {string} A representação em string HTML da barra lateral.
 */
export const Sidebar = () => {
   ...
   *
   * @param {Object} item - O objeto do item de menu.
